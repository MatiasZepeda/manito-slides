...
<div class="cover">
  ...
  <div class="cover-right">
    <div class="dot-grid">
      <div class="dot dot-c"></div><div class="dot"></div><div class="dot dot-c"></div><div class="dot"></div>
      <div class="dot"></div><div class="dot dot-c"></div><div class="dot"></div><div class="dot dot-c"></div>
      <div class="dot dot-c"></div><div class="dot"></div><div class="dot dot-c"></div><div class="dot"></div>
      <div class="dot"></div><div class="dot dot-c"></div><div class="dot"></div><div class="dot dot-c"></div>
    </div>
    <div class="cover-tagline">"Nosotros resolvemos."</div>
  </div>
</div>
...
<div class="s-slide">
<div class="s-bar">
  <span class="s-bar-title">Lo que viene</span>
  <span class="s-bar-counter">1 / 3</span>
</div>
<div class="s-body">
<div class="timeline">

<div class="phase">
  <div class="phase-head" style="background:#F19A6D">
    <div class="phase-head-title">Pre-lanzamiento</div>
    <div class="phase-head-dates">Ahora → 30 marzo</div>
  </div>
  <div class="phase-tag" style="color:#F19A6D">Esta semana</div>
  <div class="phase-body">
    <div class="phase-item">Cerrar el producto y dejarlo listo para el beta</div>
    <div class="phase-item">Preparar screenshots y descripciones para App Store y Play Store</div>
    <div class="phase-item">Armar los canales: Instagram, Facebook y WhatsApp Business</div>
    <div class="phase-item">Definir la lista de testers y preparar el mensaje de invitación</div>
  </div>
</div>

<div class="phase">
  <div class="phase-head" style="background:#4A8F9E">
    <div class="phase-head-title">Beta Cerrada</div>
    <div class="phase-head-dates">30 marzo → 13 abril</div>
  </div>
  <div class="phase-tag" style="color:#4A8F9E">2 semanas · sujeto a avance</div>
  <div class="phase-body">
    <div class="phase-item">Testeo con personas cercanas: familia y amigos como clientes y profesionales</div>
    <div class="phase-item">Validar que todos los flujos de la app funcionen en condiciones reales</div>
    <div class="phase-item">Identificar y corregir bugs críticos antes del lanzamiento</div>
    <div class="phase-item">Ajustes finales al producto antes de abrir al público</div>
  </div>
</div>

<div class="phase">
  <div class="phase-head" style="background:#1B5F6F">
    <div class="phase-head-title">Fase 1</div>
    <div class="phase-head-dates">Post 13 abril · 3–6 meses</div>
  </div>
  <div class="phase-tag" style="color:#1B5F6F">Primeros meses</div>
  <div class="phase-body">
    <div class="phase-item">Campañas en Meta Ads para atraer a los primeros clientes</div>
    <div class="phase-item">Outreach a profesionales para sumar más proveedores al servicio</div>
    <div class="phase-item">Construir una base sólida de proveedores verificados</div>
    <div class="phase-item">Aprender con data real: qué funciona y qué hay que mejorar</div>
  </div>
</div>
...
<div class="s-slide">
<div class="s-bar">
  <span class="s-bar-title">Equipo y Responsabilidades</span>
...
<div class="s-slide">
<div class="s-bar">
  <span class="s-bar-title">Los 6 Pilares</span>
  <span class="s-bar-counter">3 / 3</span>
</div>
<div class="s-body">
<div class="pillars">
...
<div class="closing">
  ...
  <div class="closing-body">
    <div class="closing-tag">Manito · 23.03.2026</div>
    <h2 class="closing-h2">Ajustes y<br>comentarios</h2>
    <div class="closing-q">
